...
Again, I tried subgrouping by all categorical variables and found that BMI separated the groups very well:

<p align="center"><img src="/output/eda/age_vs_charges_nonsmokers_grp_bmi30.png" width="500"/></p>

For the sake of further exploration, I tried adjusting the BMI cutoff to 29 and 31 to see if the data splits better

<p align="center">
  <img src="/output/eda/age_vs_charges_nonsmokers_grp_bmi29.png" width="500"/>
  <img src="/output/eda/age_vs_charges_nonsmokers_grp_bmi31.png" width="500"/>
</p>
